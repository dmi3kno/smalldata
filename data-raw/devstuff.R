...
usethis::use_description(fields = list(
  # Package = "smalldata", # default, no need to specify
  # Version = "0.0.0.9000", # default, no need to specify
  Title = "Data From The Handbook Of Small Data Sets",
  Description = "Datasets for teaching statistics.", # at least one sentence
  ...
  URL = "https://github.com/dmi3kno/smalldata",
  BugReports = "https://github.com/dmi3kno/smalldata/issues",
